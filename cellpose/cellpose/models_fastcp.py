...
from .fastcp_core import UnetModel, assign_device, check_mkl, parse_model_string
...
class CellposeModel(UnetModel):
    ...
    def __init__(
        ...
        if self.pretrained_model:
            self.net.load_model(
                pretrained_model[0], cpu=(not self.gpu)
    ...
    def train(
        ...
        model_path = self._train_net(
            ...
            save_path=save_path,
            test_while_train_root=test_while_train_root,
            custom_path=0,
